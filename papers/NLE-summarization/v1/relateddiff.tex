...
\DIFdelbegin \DIFdel{of text from multiple text resources 
}\DIFdelend \DIFaddbegin \DIFadd{from multiple-sentences texts
}\DIFaddend such as news articals.
Great progress~
...
\DIFdelbegin \DIFdel{sentence
selection }\DIFdelend \DIFaddbegin {\em \DIFadd{sentence selection}} \DIFaddend before generating summaries.
...
\DIFdelbegin \DIFdel{sentence }\DIFdelend \DIFaddbegin \DIFadd{sentences }\DIFaddend using word vectors
...
%DIF < These two models are RNN-based. 
...
%DIF < Instead, 
\DIFdelbegin \DIFdel{Our }\DIFdelend \DIFaddbegin \DIFadd{Instead, our }\DIFaddend decoder regenerates a sentence that is similar to previously generated ones.
...
\DIFadd{In this paper, we aim at reducing repetition in abstractive summarization
and evaluate the
