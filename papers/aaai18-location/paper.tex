...
\pdfinfo{
	/Title (Commonsense LocatedRelation Extraction from Large Text)
	/Author (Frank Xu, Bill Lin, Kenny Zhu)}
...
Such relation can be extracted by
a sentential classifier and the aggregation of
instances detected from those sentences.
To enable research of these tasks, we release two benchmark datasets,
one containing 5,000 annotated sentences extracted from the Gutenberg corpus;
the other containing 500 pairs of physical objects and whether they are
commonly located nearby.
We also propose baseline methods for the tasks and 
compare with a state-of-the-art general-purpose relation classifier.
\end{abstract}
