...
%Our model achieves an accuracy of 63\%
%for a task that is significantly more challenging than mono-lingual table linking. 
Possible future work includes
the automatic determination of whether a non-numerical string mention in 
a cell should or should not be linked. 
%We have ignored this problem in thispaper but such un-linkable cells are abundant in web tables, too.
