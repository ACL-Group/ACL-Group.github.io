...
In the example in \figref{fig:chinesetable}, target entities of the three columns
...
which just look like \figref{fig:chinesetable}, where entities in the same column have the same type.
