...
%
\title{Supplementary Material for ``Linking Entities in Web Tables across Languages''}
\author{
...
\maketitle
\begin{abstract}
\textbf{In this supplementary material, we introduce our work in the student abstract “Linking Entities in Web Tables across Languages” with more detailed explanation and experiments.}
Cross-lingual table linking task is to link string mentions from web tables in one language
...
Detail analysis of our approach also shows a positive and important gain
brought by the joint framework and coherence feature.
