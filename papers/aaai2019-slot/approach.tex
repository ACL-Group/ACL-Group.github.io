...
words
%\footnote{We use ``word'' in problem and model description,
...
BiLSTM (Bidirectional-LSTM) enables the
...
%\xusheng{Should we move this paragraph to into? Said too much about why we use multi-task}
...
In our problem, 
following the special structure of E-commerce knowledge base (\figref{fig:kg}),
