...
We first count number of characters of each short phrase in our CoCo dataset and the result is shown in Table \ref{tab:numCharCoCo}. %, which conforms to normal distribution. 
