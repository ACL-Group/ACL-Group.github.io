...
%\vspace{1.1cm}
\author{Siyu Ren, Kenny Zhu\textsuperscript{\rm}\thanks{Corresponding Author.}}
\affiliations{
...
Experimental results on a new dataset across four domains show that 
our framework yields distractors outperforming previous methods both 
