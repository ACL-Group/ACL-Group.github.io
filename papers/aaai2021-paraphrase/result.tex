...
\hline
\\ [-1.8ex]
\multirow{5}{3cm}{Distantly-\\Supervised}
...
% \KZ{Underlined are previous best results? Say it clearly.}
}
\end{table*}
...
% (chosen from $\{0.1, 0.2, \cdots, 1, 2, 3\}$).
