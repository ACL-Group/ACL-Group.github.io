...
\begin{abstract}
    ...
    achieve more effective model compression. Specifically, we present Low-rank Prune-And-Factorize~(LPAF), a generic framework for task-specific language model compression. We further propose two techniques: sparsity-aware SVD and mixed-rank 
    fine-tuning, which improve the initialization and training of the 
    compression procedure respectively.  
    Experiments on natural language understanding and question answering tasks 
    show that the proposed method achieves better compression-performance 
    trade-off compared to existing approaches, especially under large
