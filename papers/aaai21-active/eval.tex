...
\begin{figure}[th]
	...
	\subfloat[HuffPost (HP)]{\includegraphics[width=0.2\textwidth, height=0.11\textheight]{figs/news_dis.eps}} \hfill \\
...
%	\subfloat[Emoji (EM)]{\includegraphics[width=0.2\textwidth, height=0.11\textheight]{figs/emoji_dis.eps}}
	\subfloat[TNEWS (TN)]{\includegraphics[width=0.2\textwidth, height=0.11\textheight]{figs/tnews_dis.eps}} \hfill \\

	\subfloat[GCS]{\includegraphics[width=0.2\textwidth, height=0.11\textheight]{figs/yanjing_dis.eps}}
	\subfloat[Book (BK)]{\includegraphics[width=0.2\textwidth, height=0.11\textheight]{figs/book_dis.eps}} \hfill
...
and \figref{fig:distribution}.\footnote{The data and its origin 
...
\begin{figure}[!h]
\centering
	\subfloat[Reuters]{\includegraphics[width=0.23\textwidth]{res/reuters_acc_all.pdf}}
	\subfloat[HuffPost]{\includegraphics[width=0.23\textwidth]{res/news_acc_all.pdf}} \hfill \\
%	\subfloat[Biomedical]{\includegraphics[width=0.23\textwidth]{res/ft_Biomedical_tokenized_acc_all.eps}} % \newline
	...
	\subfloat[SearchSnippets]{\includegraphics[width=0.23\textwidth]{res/search_acc_all.pdf}}
%		\subfloat[Emoji]{\includegraphics[width=0.23\textwidth]{res/ft_emoji_tokenized_acc_all.eps}}
	\subfloat[TNEWS]{\includegraphics[width=0.23\textwidth]{res/tnews_acc_all.pdf}} \hfill \\
	\subfloat[GCS]{\includegraphics[width=0.23\textwidth]{res/yanjing_acc_all.pdf}}
	\subfloat[Book]{\includegraphics[width=0.23\textwidth]{res/book_acc_all.pdf}}
\caption{Macro F1 curve of AL approaches on 6 datasets using fastText.}
\label{fig:acc_all}
\end{figure}
...
\centering
		...
		\subfloat[HuffPost]{\includegraphics[width=0.23\textwidth]{figs/bert_news_epoch5_acc_all.eps}} \hfill \\
...
%		\subfloat[Emoji]{\includegraphics[width=0.23\textwidth]{figs/bert_emoji_epoch5_run1_acc_all.eps}}
		\subfloat[TNEWS]{\includegraphics[width=0.23\textwidth]{figs/bert_tnews_epoch5_acc_all.eps}}\hfill \\
	...
	\caption{Macro F1 curve of AL approaches on 6 datasets using BERT.}
	\label{fig:acc_all_bert}
\end{figure}

\begin{figure}[!h]%[!hbt]
		\subfloat[Reuters]{\includegraphics[width=0.23\textwidth]{res/lstm_pytorch_reuters_new_acc_all.eps}}
		\subfloat[HuffPost]{\includegraphics[width=0.23\textwidth]{res/lstm_pytorch_news_reshuffle_tokenized_acc_all.eps}} \hfill \\
...
%		\subfloat[Emoji]{\includegraphics[width=0.23\textwidth]{res/lstm_pytorch_emoji_tokenized_acc_all.eps}} 
		\subfloat[TNEWS]{\includegraphics[width=0.23\textwidth]{res/lstm_pytorch_tnews_tokenized_acc_all.eps}} \hfill \\
...
\caption{Macro F1 curve of AL approaches on 6 datasets using LSTM.}
...
\centering
		...
		\subfloat[HuffPost]{\includegraphics[width=0.23\textwidth]{res/cnn_pytorch_news_reshuffle_tokenized_acc_all.eps}} \hfill \\
	...
	%	\subfloat[Emoji]{\includegraphics[width=0.23\textwidth]{res/cnn_pytorch_emoji_tokenized_acc_all.eps}}
		\subfloat[TNEWS]{\includegraphics[width=0.23\textwidth]{res/cnn_pytorch_tnews_tokenized_acc_all.eps}} \hfill \\
	...
	\caption{Macro F1 curve of AL approaches on 6 datasets using CNN.}
