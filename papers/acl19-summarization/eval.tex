...
We follow See~\shortcite{SeeLM17}'s in data preprocessing and use 
...
After adding operations at testing, 
...
problem, we compare \textit{repeatedness} (\tabref{tab:eval_repe}) 
and \textit{redundancy} (\tabref{tab:eval_cor}) of generated summaries.
