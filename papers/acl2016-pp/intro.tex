...
\centering
\scalebox{0.55}{\includegraphics[angle=270]{kb-schema-crop.eps}}
\label{fig:kb-schema}
...
%\KQ{Currently we don't talk about the others disadvantages of skeleton based method, since we will discuss the advantage of schemas in the later part of this section.}
...
In this paper, we propose to generalize the path representation
