...
we propose a novel evaluation benchmark to evaluate high-level cognitive ability of 
LVLMs using images with rich semantics~\footnote{
The code and part of the data is temporarily released at: https://anonymous.4open.science/r/CogBench-D1E7, while the full version of the code and data will be released after the paper is accepted.
% Code and data are available at \\
% \href{https://github.com/xiujiesong/Cog-Bench}{https://github.com/xiujiesong/Cog-Bench}.
}.
...
Our evaluation on well-known LVLMs shows that there is still a large gap in 
cognitive ability between LVLMs and humans. 
% \KZ{Abstract too long!}\XJ{Will keep making it short.}
\end{abstract}
