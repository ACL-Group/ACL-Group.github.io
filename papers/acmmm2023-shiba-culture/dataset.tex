...
Additionally, host's speech from the same video is extracted using a similar approach as we process dog barks. This procedure will be described in detail in~\secref{sec:speechextraction}.
...
\begin{figure}[ht]
	\centering
	\subfigure[source videos and tag language]{
		\includegraphics[width=0.45\columnwidth]{images/image0.jpg}
	}
	\quad
	\subfigure[sentence-level segmentations]{
		\includegraphics[width=0.45\columnwidth]{images/image1.jpg}
	}
	\quad
	\subfigure[clean data after noise removing]{
		\includegraphics[width=0.42\columnwidth]{images/image2.jpg}
		%\caption{fig1}
	}
	\quad
	\subfigure[word-level barks]{
		\includegraphics[width=0.45\columnwidth]{images/image3.jpg}
	}
	\quad
	\subfigure[context tagging]{
		\includegraphics[width=0.9\columnwidth]{images/image4.jpg}
	}
	\caption{The procedure of the dataset construction can be briefly divided into several parts. 
%\KZ{There should be an (e) Metadata tagging.}
	}
	\label{fig:methodpic}
	\Description {The procedure of dataset constrcution, including source the videos and tag language, sentence-level segmentation, clean data after noise removing, word-level bargs segmentation and metadata tagging.}
\end{figure}
...
and {\em activity}, three components of the bark context in \tabref{tab:context}. The set of values for locations values is a subset of the location set from Inception-ResNet-V2 model. 
