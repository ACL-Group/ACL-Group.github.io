...
\newcommand{\LQ}[1]{\textcolor{green}{LuQi: #1}}
...
\title{Cross-region Traffic Prediction for China on OpenStreetMap (Systems Paper)}
...
Frank F. Xu~~~ Bill Y. Lin~~~ Qi Lu~~~ Yifei Huang~~~ Kenny Q. Zhu\\
       ...
       \email{\{frankxu,yuchenlin,icedream,5130309269,kenzhu\}@sjtu.edu.cn}
}
...
traffic information or prediction
of traffic for China. This paper presents an approach and a
system to 
...
transportation dispatching as well as personal travel planning.
