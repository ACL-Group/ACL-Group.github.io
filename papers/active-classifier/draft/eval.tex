\begin{figure}[th]
	...
	\subfloat[SQD]{\includegraphics[width=0.25\textwidth, height=0.125\textheight]{figs/stack_dis.eps}}\newline
    ...
    \subfloat[Stackoverflow]{\includegraphics[width=0.25\textwidth, height=0.125\textheight]{figs/new_stack_dis.eps}}
...
%		Avg Char/sample & ---        & ---        & 22.7        & 9.7          & ---& ---& ---            \\
%		Min Char/sample & --- &--- &2 & 1& ---& ---& ---\\
%		Max Char/sample & --- & --- & 150 & 279 & ---& ---& ---\\
...
In addition, we tuned some of the strong methods with class frequency and treat them as new methods. The performance of the 12 methods on 7 datasets is shown in a few tables. \tabref{table:auc_ft}, \tabref{table:auc_bert}, \tabref{table:auc_cnn} and \tabref{table:auc_lstm} presents the results on the above 7 datasets using fastText, BERT, CNN as well as LSTM with attention (denoted as LSTM+ATTN) respectively. To illustrate our results, we plot the macro-F1 curves of 
...
\begin{figure}[th!]%[!hbt]
\begin{center}
\subfloat[Legend]{\includegraphics[scale=0.65]{figs/legend_4.pdf}}
\end{center}
\noindent
\begin{center}
\subfloat[Reuters]{\includegraphics[width=0.24\textwidth]{figs/reuters_acc_all.pdf}}
\subfloat[SQD]{\includegraphics[width=0.24\textwidth]{figs/stackoverflow_acc_all.pdf}}
\end{center}
\noindent
\begin{center}
\subfloat[TNEWS]{\includegraphics[width=0.24\textwidth]{figs/tnews_acc_all.pdf}} % \newline
\subfloat[GCS]{\includegraphics[width=0.24\textwidth]{figs/yanjing_acc_all.pdf}}
\end{center}
\noindent
\begin{center}
	\subfloat[Biomedical]{\includegraphics[width=0.24\textwidth]{figs/ft_Biomedical_tokenized_acc_all.pdf}} % \newline
	\subfloat[StackOverflow]{\includegraphics[width=0.24\textwidth]{figs/ft_StackOverflow_tokenized_acc_all.pdf}}
\end{center}
\noindent
\begin{center}
	\subfloat[SearchSnippets]{\includegraphics[width=0.24\textwidth]{figs/ft_SearchSnippets_tokenized_acc_all.pdf}} % \newline
\end{center}
\caption{Macro F1 curve of AL approaches on 7 datasets using fastText}
\label{fig:acc_all}
\end{figure}
...
%	\end{center}
	...
	\caption{Macro F1 curve of AL approaches on 7 datasets using BERT}
...
\begin{figure}[th!]%[!hbt]
	\noindent
	\begin{center}
		\subfloat[Reuters]{\includegraphics[width=0.24\textwidth]{figs/lstm_pytorch_reuters_new_merge_acc_all.pdf}}
		\subfloat[SQD]{\includegraphics[width=0.24\textwidth]{figs/lstm_pytorch_stackoverflow_tokenized_merge_acc_all.pdf}}
	\end{center}
	\noindent
	\begin{center}
		\subfloat[TNEWS]{\includegraphics[width=0.24\textwidth]{figs/lstm_pytorch_tnews_tokenized_merge_acc_all.pdf}} % \newline
		\subfloat[GCS]{\includegraphics[width=0.24\textwidth]{figs/lstm_pytorch_yanjing_tokenized_merge_acc_all.pdf}}
	\end{center}
	\noindent
	\begin{center}
		\subfloat[Biomedical]{\includegraphics[width=0.24\textwidth]{figs/lstm_pytorch_Biomedical_tokenized_acc_all.pdf}}
		\subfloat[StackOverflow]{\includegraphics[width=0.24\textwidth]{figs/lstm_pytorch_stackoverflow_tokenized_acc_all.pdf}}
	\end{center}
	\noindent
	\begin{center}
		\subfloat[SearchSnippets]{\includegraphics[width=0.24\textwidth]{figs/lstm_pytorch_SearchSnippets_tokenized_acc_all.pdf}}
	\end{center}
	\caption{Macro F1 curve of AL approaches on 7 datasets using LSTM+ATTN}
...
\begin{figure}[th!]%[!hbt]
	\noindent
	\begin{center}
		\subfloat[Reuters]{\includegraphics[width=0.24\textwidth]{figs/cnn_pytorch_reuters_new_merge_acc_all.pdf}}
		\subfloat[SQD]{\includegraphics[width=0.24\textwidth]{figs/cnn_pytorch_stackoverflow_tokenized_merge_acc_all.pdf}}
	\end{center}

%	\noindent
%	\begin{center}
%		\subfloat[TNEWS]{\includegraphics[width=0.24\textwidth]{figs/cnn_pytorch_tnews_tokenized_merge_acc_all.pdf}} % \newline
%		\subfloat[GCS]{\includegraphics[width=0.24\textwidth]{figs/cnn_pytorch_yanjing_tokenized_merge_acc_all.pdf}}
%	\end{center}

	\noindent
	\begin{center}
		\subfloat[TNEWS]{\includegraphics[width=0.24\textwidth]{figs/cnn_pytorch_tnews_tokenized_fixed_acc_all.pdf}} % \newline
		\subfloat[GCS]{\includegraphics[width=0.24\textwidth]{figs/cnn_pytorch_yanjing_tokenized_fixed_acc_all.pdf}}
	\end{center}
	\begin{center}
	...
	\end{center}
	\caption{Macro F1 curve of AL approaches on 7 datasets using CNN}
