...
\secref{sec:discuss}). Those images will then be processed by the OCR Engine and will be turned into files in XML form with spatial annotations. What's more, descriptions about those images in ODL will also be created by graphical user interfaces. Those graphical user interfaces will  generate descriptions mentioned above automatically given some parameters, which means it will save lots of work by the users.
...
\figref{fig:description}. Our later discussion on the ODL language
will use the abstract syntax instead. 
The corresponding abstract syntax of \figref{fig:description}
