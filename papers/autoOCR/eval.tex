...
\begin{figure}[ht]
\centering
\epsfig{file=figure/17_zOCR.eps, width=0.8\columnwidth}
...
\begin{figure}[ht]
\centering
\epsfig{file=figure/2_pl.eps, width=0.9\columnwidth}
...
\subfloat{
%% \label{fig:hc:1}
\epsfig{file=figure/hcf1.eps, width=5cm}
}
% \hfill
% \centering
\subfloat{
% \label{fig:hc:2}
\epsfig{file=figure/hcf2.eps, width=5cm}
}
\hfill
% % \centering
\subfloat{
% \label{fig:hc:3}
\epsfig{file=figure/hcf3.eps, width=5cm}
}
% % \centering
\subfloat{
% \label{fig:hc:4}
\epsfig{file=figure/hcf4.eps, width=5cm}
}
