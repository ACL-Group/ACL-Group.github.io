...
\subfloat[Format 1]{
\label{fig:dataset:1}
\epsfig{file=figure/f1.eps, width=0.96\columnwidth}
}
% \hfill
\subfloat[Format 2]{
\label{fig:dataset:2}
\epsfig{file=figure/f2.eps, width=0.96\columnwidth}
}
\hfill
\subfloat[Format 3]{
\label{fig:dataset:3}
\epsfig{file=figure/f3.eps, width=0.72\columnwidth}
}
\subfloat[Format 4]{
\label{fig:dataset:4}
\epsfig{file=figure/f4.eps, width=1.20\columnwidth}
}
...
\epsfig{file=figure/preprocess.eps, width=0.96\columnwidth}
}
...
% TODO: we assign 6 undergrad students (with CS background) as the volunteer
% write each 4 format.
% it takes 1 hour for training, finish writing within 20min.
% among 24 annotations, 21 are good: left-to-right and top-to-bottom manner,
% adding spaces when there are big margins (for example, at least 3 rows vertical)

\begin{figure*}[ht]
\centering
\epsfig{file=figure/zonal_OCR.eps, width=1.9\columnwidth}
...
% TODO: We run the experiment on Intel i5xxxx with xxx memories, running in single threaded.
% TODO: For all graphs of each format, the parsing processes all figures within in 1.5 second on average.
...
\subfloat{
%% \label{fig:hc:1}
\epsfig{file=figure/hcf1.eps, width=0.96\columnwidth}
}
% \hfill
% \centering
\subfloat{
% \label{fig:hc:2}
\epsfig{file=figure/hcf2.eps, width=0.96\columnwidth}
}
\hfill
% % \centering
\subfloat{
% \label{fig:hc:3}
\epsfig{file=figure/hcf3.eps, width=0.96\columnwidth}
}
% % \centering
\subfloat{
% \label{fig:hc:4}
\epsfig{file=figure/hcf4.eps, width=0.96\columnwidth}
}
