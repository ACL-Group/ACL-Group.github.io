...
\runninghead{Luo, Lu, Zhu, Gao, Wei and Zhang}

\title{Fault-tolerant Information Extraction from Semi-structured OCR Images}

\author{
    Kangqi Luo\affilnum{1},
    Jinyi Lu\affilnum{1},
    Kenny Q. Zhu\affilnum{1},
    Weiguo Gao\affilnum{2},
    Jia Wei\affilnum{2} and
    Meizhuo Zhang\affilnum{2}}

\affiliation{\affilnum{1}Shanghai Jiao Tong University, China\\
\affilnum{2}AstraZeneca China}
