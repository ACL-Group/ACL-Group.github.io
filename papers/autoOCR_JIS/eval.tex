...
\subfloat[Format 1]{
\label{fig:dataset:1}
\epsfig{file=f1.eps, width=0.5\columnwidth}
}
% \hfill
\subfloat[Format 2]{
\label{fig:dataset:2}
\epsfig{file=f2.eps, width=0.5\columnwidth}
}
\hfill
\subfloat[Format 3]{
\label{fig:dataset:3}
\epsfig{file=f3.eps, width=0.5\columnwidth}
}
\subfloat[Format 4]{
\label{fig:dataset:4}
\epsfig{file=f4.eps, width=0.5\columnwidth}
}
...
\centering
\epsfig{file=17_zOCR.eps, width=0.95\columnwidth}
\caption{Image Marked With Zones}
\label{fig:zOCR}
%\end{minipage}
%\begin{minipage}{0.9\columnwidth}
\centering
\epsfig{file=17_pl.eps, width=0.95\columnwidth}
...
\begin{figure}[th]
\centering
\epsfig{file=2_pl.eps, width=0.95\columnwidth}
