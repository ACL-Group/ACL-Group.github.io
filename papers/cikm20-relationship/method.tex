...
An example is given in \figref{fig:address}. 
...
We define ``indicative'' as ``significantly more likely to occur in 
...
Note that all of these statistical preprocessing for keyword selection 
is accomplished on the {\em training set}, leaving the test data unseen. 
We do the same with bigrams and 
