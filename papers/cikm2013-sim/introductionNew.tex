...
\pair{music}{lunch}\footnote{This pair shares the same hypernyms, such as ``activity''.}, \pair{banana}{beef} \footnote{This pair shares the same hypernyms, such as ``food''.}
