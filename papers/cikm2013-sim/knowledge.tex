...
We can represent $\Gamma_{isA}$ as $\Gamma_{isA}$ = \{\pair{c}{e}\},
...
%{\color{red} The edit distance based method is very simple while the performance is closely relevant to the threshold $\varphi$. We know that
