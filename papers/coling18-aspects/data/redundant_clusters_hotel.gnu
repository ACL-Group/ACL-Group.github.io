...
set output 'redundant_clusters_hotel.eps'
...
set xlabel 'Number of redundant clusters (C-K)'
set ylabel "Accuracy"
...
plot 'redundant_clusters_hotel.txt' index 0 with linespoints ls 1 t 'K = 3', \
