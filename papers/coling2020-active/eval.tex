...
\begin{figure*}[th]
    ...
    \begin{center}
	\subfloat[Reuters (RT)]{\includegraphics[width=0.2\textwidth, height=1.9cm]{figs/reuters_dis.eps}}
	\subfloat[HuffPost (HP)]{\includegraphics[width=0.2\textwidth, height=1.9cm]{figs/news_dis.eps}}
	\subfloat[Biomedical (Bio)]{\includegraphics[width=0.2\textwidth, height=1.9cm]{figs/bio_dis.eps}}
	\subfloat[Search Snippets (SS)]{\includegraphics[width=0.2\textwidth, height=1.9cm]{figs/search_dis.eps}}\newline      
    \end{center}

	\subfloat[Emoji (EM)]{\includegraphics[width=0.2\textwidth, height=1.9cm]{figs/emoji_dis.eps}}
	\subfloat[TNEWS (TN)]{\includegraphics[width=0.2\textwidth, height=1.9cm]{figs/tnews_dis.eps}}
	\subfloat[GCS]{\includegraphics[width=0.2\textwidth, height=1.9cm]{figs/yanjing_dis.eps}}
	\subfloat[Book (BK)]{\includegraphics[width=0.2\textwidth, height=1.9cm]{figs/book_dis.eps}}\newline
...
\noindent
	\begin{center}
		\subfloat[Reuters]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/ft_reuters_new_acc_all.eps}}
		\subfloat[HuffPost]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/ft_news_tokenized_norm_acc_all.eps}}
		\subfloat[Biomedical]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/ft_Biomedical_tokenized_acc_all.eps}} % \newline
		%\subfloat[StackOverflow]{\includegraphics[width=0.24\textwidth]{figs/ft_SO_tokenized_acc_all.pdf}}
		\subfloat[SearchSnippets]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/ft_SearchSnippets_tokenized_acc_all.eps}}
	\end{center}
	\noindent
	
	\begin{center}
		\subfloat[Emoji]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/ft_emoji_tokenized_acc_all.eps}}
		\subfloat[TNEWS]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/ft_tnews_tokenized_acc_all.eps}} % \newline
		\subfloat[GCS]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/ft_yanjing_tokenized_acc_all.eps}}
		\subfloat[Book]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/ft_book_tokenized_acc_all.eps}}
	\end{center}
...
\begin{figure*}[th!]%[!hbt]
	...
	\setlength{\belowcaptionskip}{0pt}
	\begin{center}
		\subfloat[Reuters]{\includegraphics[width=0.23\textwidth,height=1.9cm]{figs/bert_reuters_new_epoch5_acc_all.eps}}
		\subfloat[HuffPost]{\includegraphics[width=0.23\textwidth,height=1.9cm]{figs/bert_news_epoch5_acc_all.eps}}
		\subfloat[Biomedical]{\includegraphics[width=0.23\textwidth,height=1.9cm]{figs/bert_Bio_epoch5_run1_acc_all.eps}}
		\subfloat[SearchSnippets]{\includegraphics[width=0.23\textwidth,height=1.9cm]{figs/bert_Search_epoch5_run1_acc_all.eps}}
	\end{center}
	\noindent
	\begin{center}
		\subfloat[Emoji]{\includegraphics[width=0.23\textwidth,height=1.9cm]{figs/bert_emoji_epoch5_run1_acc_all.eps}}
		\subfloat[TNEWS]{\includegraphics[width=0.23\textwidth,height=1.9cm]{figs/bert_tnews_epoch5_acc_all.eps}}
		\subfloat[GCS]{\includegraphics[width=0.23\textwidth,height=1.9cm]{figs/bert_yanjing_epoch5_acc_all.eps}}
		\subfloat[Book]{\includegraphics[width=0.23\textwidth,height=1.9cm]{figs/bert_book_epoch5_run1_acc_all.eps}}
	\end{center}
...
\begin{figure*}[th!]%[!hbt]
	...
	\setlength{\belowcaptionskip}{0pt}
	\begin{center}
		\subfloat[Reuters]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/lstm_pytorch_reuters_new_acc_all.eps}}
		\subfloat[HuffPost]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/lstm_pytorch_news_reshuffle_tokenized_acc_all.eps}}
		\subfloat[Biomedical]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/lstm_pytorch_Biomedical_tokenized_acc_all.eps}}
		\subfloat[SearchSnippets]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/lstm_pytorch_SearchSnippets_tokenized_acc_all.eps}}
	\end{center}
	\noindent
	\begin{center}
		\subfloat[Emoji]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/lstm_pytorch_emoji_tokenized_acc_all.eps}} 
		\subfloat[TNEWS]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/lstm_pytorch_tnews_tokenized_acc_all.eps}} 
		\subfloat[GCS]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/lstm_pytorch_yanjing_tokenized_acc_all.eps}}
		\subfloat[Book]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/lstm_pytorch_book_tokenized_acc_all.eps}}
	\end{center}
...
\begin{figure*}[th!]%[!hbt]
	...
	\setlength{\belowcaptionskip}{0pt}
	\begin{center}
		\subfloat[Reuters]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/cnn_pytorch_reuters_new_acc_all.eps}}
		\subfloat[HuffPost]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/cnn_pytorch_news_reshuffle_tokenized_acc_all.eps}}
		\subfloat[Biomedical]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/cnn_pytorch_Biomedical_tokenized_acc_all.eps}}
		\subfloat[SearchSnippets]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/cnn_pytorch_SearchSnippets_tokenized_acc_all.eps}}
	\end{center}

	\noindent
	\begin{center}
		\subfloat[Emoji]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/cnn_pytorch_emoji_tokenized_acc_all.eps}}
		\subfloat[TNEWS]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/cnn_pytorch_tnews_tokenized_acc_all.eps}} % \newline
		\subfloat[GCS]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/cnn_pytorch_yanjing_tokenized_acc_all.eps}}
		\subfloat[Book]{\includegraphics[width=0.23\textwidth,height=1.9cm]{res/cnn_pytorch_book_tokenized_acc_all.eps}}
	\end{center}
...
In order to determine which classifier is better to use with AL, we conduct same experiments on four popular classifiers. \Cref{fig:acc_all,fig:acc_all_bert,fig:acc_all_lstm,fig:acc_all_cnn} show AUC* of different strategies on fastText, CNN, LSTM as well as BERT. As depicted in the figures, 
...
larger than fastText. \tabref{table:trainingtime} shows that 
...
%filtering the dataset leaving only those data points with the top 2, 5 and 10 class labels. 
