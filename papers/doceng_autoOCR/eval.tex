...
The statistics of the dataset is in \tabref{tab:statis}. 
...
%An example result of our page layout 
...
%\subfloat{
%% \label{fig:hc:3}
%\epsfig{file=figure/hcf3.eps, width=0.45\columnwidth}
%}
%% % \centering
%\subfloat{
%% \label{fig:hc:4}
%\epsfig{file=figure/hcf4.eps, width=0.45\columnwidth}
%}
