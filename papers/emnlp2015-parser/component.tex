...
\begin{figure*}[th]
\centering
\epsfig{file=exampleparse_emnlp.eps, width=1.8\columnwidth}
...
\textbf{Action classifier in MaltParser }MaltParser employs a
...
%{\bf Scorer-based  }
\textbf{Feature score based predictor }The intuition of sequence predictor
