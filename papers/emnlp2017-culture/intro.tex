...
The second task is bilingual lexicon induction for Internet slang terms. 
...
%which reflect cultural and socio-linguistic 
%context of terms in different cultures.\\
...
for cross-cultural social studies with low-cost bilingual resources. (\secref{sec:socvec})
