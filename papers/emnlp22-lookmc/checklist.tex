...
\begin{Form}
\begin{tabular}{l}
    \cm{mainClaims}{Yes,No,N/A}{Yes}\\[0.2cm]
    \tf[0.85]{mainClaimsJustification}{In the last section, Limitation}
\end{tabular}
\end{Form} \\[0.3cm]
...
\begin{Form}
\begin{tabular}{l}
    \cm{risks}{Yes,No,N/A}{Yes}\\[0.2cm]
    \tf[0.85]{risksJustification}{In the last section, Limitation}
\end{tabular}
\end{Form}
...
\begin{Form}
\begin{tabular}{l}
    \cm{abstractIntro}{Yes,No,N/A}{Yes}\\[0.2cm]
    \tf[0.85]{abstractIntroJustification}{In Section 1}
\end{tabular}
\end{Form}
...
\begin{Form}
\begin{tabular}{l}
\cm{createArtifacts}{Yes,No,N/A}{No}\\[0.2cm]
\end{tabular}
\end{Form}
...
\begin{Form}
\begin{tabular}{l}
    \cm{computationalExperiments}{Yes,No,N/A}{Yes}
\end{tabular}
\end{Form}
...
\begin{Form}
\begin{tabular}{l}
    \cm{reportReproducibility}{Yes,No,N/A}{Yes}\\[0.2cm]
    \tf{reportReproducibilityJustification}{In Section 3.1.3}
\end{tabular}
\end{Form} \\[0.3cm]
...
\begin{Form}
\begin{tabular}{l}
    \cm{bestFoundHyperparameter}{Yes,No,N/A}{yes}\\[0.2cm]
    \tf{bestFoundHyperparameterJustification}{In Section 3.1.}
\end{tabular}
\end{Form} \\[0.3cm]
...
\begin{Form}
\begin{tabular}{l}
    \cm{descriptiveStatistics}{Yes,No,N/A}{Yes}\\[0.2cm]
    \tf{descriptiveStatisticsJustification}{In Section 3.2}
\end{tabular}
\end{Form} \\[0.3cm]
...
\begin{Form}
\begin{tabular}{l}
    \cm{existingPackages}{Yes,No,N/A}{Yes}\\[0.2cm]
    \tf{existingPackagesJustification}{In Section 2.2.2}
\end{tabular}
\end{Form} \\[0.3cm]
...
\begin{Form}
\begin{tabular}{l}
    \cm{hummanAnnotators}{Yes,No,N/A}{Yes}\\
\end{tabular}
\end{Form}
...
\begin{Form}
\begin{tabular}{l}
    \cm{fullTextInstructions}{Yes,No,N/A}{Yes}\\[0.2cm]
    \tf{fullTextInstructionsJustification}{In Section 3.1.2 and 3.1.3}
\end{tabular}
\end{Form} \\[0.3cm]
...
\begin{Form}
\begin{tabular}{l}
    \cm{payment}{Yes,No,N/A}{Yes}\\[0.2cm]
    \tf{paymentJustification}{In Section 3.1.2 and 3.1.3}
\end{tabular}
\end{Form} \\[0.3cm]
...
\begin{Form}
\begin{tabular}{l}
    \cm{consent}{Yes,No,N/A}{Yes}\\[0.2cm]
    \tf{consentJustification}{In Section 3.1.2 and 3.1.3}
\end{tabular}
\end{Form} \\[0.3cm]
...
\begin{Form}
\begin{tabular}{l}
    \cm{ethicsAmountSpent}{Yes,No,N/A}{No}\\[0.2cm]
    \tf{ethicsAmountSpentJustification}{Our annotation tasks is derived from original tasks which is widely used in reasoning area.}
\end{tabular}
\end{Form} \\[0.3cm]
...
\begin{Form}
\begin{tabular}{l}
    \cm{annotator}{Yes,No,N/A}{No}\\[0.2cm]
    \tf{annotatorJustification}{This information is not very important for annotation results, because it is a commonsense reasoning task which is irrelative to demographic and geographic.}
\end{tabular}
\end{Form} \\[0.3cm]
