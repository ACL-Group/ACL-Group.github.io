...
Among all operators listed in \tabref{table:proxyop}, 
...
\textit{Crossover} is visually illustrated in \figref{fig:cross}. It operates across two different questions.
...
\textit{Mutation} is visually illustrated in \figref{fig:mutation}. \textit{Mutation} operation swaps two consecutive words either in the right choice or wrong choice of the original MCQ, each with 50\% probability.
