...
test. 
%Visualization of the meaningful representations learned in the 
%attribute semantic space also supports its effectiveness.
\footnote{Code and data are available at \url{https://github.com/blmoistawinde/DASC}.}
% \footnote{Code and data are available on the submission system.}
\end{abstract}
