...
\input{Sec./intro}
\input{Sec./problem definition}
\input{Sec./approach}
\input{Sec./eval}
\input{Sec./Related Work}
\input{Sec./Conclude}
\input{Sec./Limitations}
\input{Sec./Ethics Statement}
...
\appendix
% \input{Sec./nodes and edges}
% \input{Sec./lawgraph construction}
\input{Sec./graph}
\input{Sec./Case study}
\input{Sec./Experiment}
\input{Sec./GPT test}
\input{Sec./reliability}
