...
\begin{table*}[th]
 ...
 communication} & {Encouragement  \( \mbox{\&} \) affirmation} & {All}\\ \midrule
	...
	\end{tabular}
	\caption{Success rate of chatbot / human roles. The success rate is calculated as described in \secref{result_interaction}. The red and blue bold parts in the table represent the best performance of chatbot and human in role and strategy respectively, and the black bold part represents the highest total success rate of human.}%\KZ{What are the numbers in the table?
