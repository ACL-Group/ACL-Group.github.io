...
\begin{document}
	...
	\title{Automatically Mining Commonsense \lnear\ Relationship from Text}
...
which is a type of useful commonsense knowledge in 
computer vision, language understanding, etc. 
		...
		%by human annotators. 
We propose to automatically discover such relation through
a sentence-level classification problem and the aggregation of
instances detected from a large number of sentences.
