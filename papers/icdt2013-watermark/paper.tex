...
\usepackage{times,epsfig,proof,url,algorithm,algpseudocode,bm}
\usepackage{amsmath}
\usepackage{textcomp}
\usepackage{graphicx}
...
road maps.  Past research on watermarking road maps has been focused on
...
to form a new map. Conventional watermarking techniques either fail with
...
and usability of the maps. This paper proposes a noval quad-tree based
