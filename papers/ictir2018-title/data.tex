...
\begin{table}[th]
	...
	\begin{tabular}{l|r}
		...
		%  & XXX \\ %& LCSTS  \\
		% \midrule
		Number of summaries & 6,481,623 \\%& 2,400,591  \\
		\midrule
		Number of words per text  & 12 \\ %& 60 \\
		\midrule
		Number of chars per text & 27  \\ %& 105 \\
		\midrule
		Number of words per summary & 5  \\ %& 10  \\
		\midrule
		Number of chars per summary & 11  \\ %& 19 \\
		%\midrule
