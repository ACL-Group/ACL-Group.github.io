...
We also tune the threshold $\tau$ used in BiLSTM-Net and our Wide\&\\Deep-Net.
...
\caption{
	...
	We use the tuned threshold $\tau=0.4$ (see \figref{fig:eval}) for BiLSTM-Net and Wide\&Deep-Net.
...
\begin{figure*}[th]
	\centering
	\epsfig{file=fig/exp.eps, angle=0, width=1.6\columnwidth}
