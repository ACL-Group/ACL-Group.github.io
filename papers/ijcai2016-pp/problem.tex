...
As what we've shown in \figref{fig:fb-schema}, though there is there no
...
\scalebox{0.3}{\includegraphics[angle=270]{fb-schema-4.eps}}
...
Next, we expain how we obtain the cost function based on the view of information theory (\secref{sec:scoring}),
