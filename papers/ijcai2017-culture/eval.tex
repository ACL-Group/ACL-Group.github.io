...
%Afterwards, we filter out ``@'' mentions, 
%hashtags, excessive punctuations and repetitive characters. 
...
%Another important lexicon we use for English is OpinionFinder, which consists of words relevant to opinion, sentiment, cognition and other psychological processes, from which we turn our SocVec space into more opinion-sensitive. 
%The Chinese counterpart for Empath is TextMind, which is similar to LIWC for analysis the preferences and degrees of different categories in text with an emphasize on Chinese characteristics.
%All of these three lexicons are used on a combinatorial basis acting as a parameter to our SocVec model.
%
