...
%\KZ{The following may not be needed at this stage.
...
%\begin{figure}[th]
%	\centering
%	\includegraphics[width=0.35\textwidth]{pic/example.pdf}
%	\caption{\label{fig:example} A science article excerpted from Wikipedia page Mali.}
%\end{figure}
...
%The document in this dataset is the pure text from the whole Wikipedia page, ignoring all the headings.
