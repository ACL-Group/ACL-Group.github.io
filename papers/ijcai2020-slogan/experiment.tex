...
\begin{table}[th!]
	\begin{center}
		...
		\subfloat[Examples of relation identification in our method.]{
			...
			\begin{tabular}{c|c|c}
				...
				& \begin{tabular}{p{6em}<{\centering}} (女 装, \emph{hyper}, 妈 妈 装)  \\ (women's clothing, \emph{hyper}, mother-dress ) \end{tabular} \\ 
				\hline
				...
				\end{tabular} 
				& \begin{tabular}{p{8em}<{\centering}} (护 小 腿, \emph{hypo}, 护 具)  \\ (leg protector, \emph{hypo}, protective gear) \\
	...
	\qquad
		...
		\begin{tabular}{c|c}
			\hline  
			model                                     & slogans                           \\ \hline
			\begin{tabular}{p{5em}<{\centering}}Two-CAT\end{tabular}
			& \begin{tabular}{p{16em}} 中 老 年 连 衣 裙 , 时 尚 \\ 
			middle-aged and old women's dress, fashion\end{tabular} \\ 
			\begin{tabular}{p{6em}<{\centering}}SALE\end{tabular}	
			& \begin{tabular}{p{16em}} 中 老 年 连 衣 裙 , \color{blue}{送 妈 妈}  \color{black}{的 首 选}\\
			middle-aged and old women's dress, the best choice \color{blue}{for mommy}
		 \end{tabular} \\ 
			\hline
			\begin{tabular}{p{5em}<{\centering}}Two-CAT\end{tabular}
			& \begin{tabular}{p{16em}} 运 动 套 装 , 穿 出 潮 流 感 \\ 
			sports sweatsuit, fashion \end{tabular} \\ 
			\begin{tabular}{p{6em}<{\centering}}SALE\end{tabular}	
			& \begin{tabular}{p{16em}} 运 动 不 能 少 , 时 刻 \color{blue}{保 护} 你 \\ 
