...
Then we learn an L2-SVM model to classify these words, and filter out meaningless
...
\begin{figure}[th]
	\centerline{\psfig{figure=context_bean.eps,width=\columnwidth}}
...
\State {$Context \leftarrow \varnothing$}
