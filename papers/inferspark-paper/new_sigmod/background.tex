...
\KZ{Focus on bayesian models. Give examples of SLDA, GMM and BPM.}
...
\KZ{The first part can be simplified and only talks superficially about the
intractibility.}
...
\KZ{Mention, VMP, Gibbs sampling and EP here.}
