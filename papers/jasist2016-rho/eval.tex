...
%  \includegraphics[width=0.5\columnwidth]{BMS-POS.eps}
%\end{minipage}%
\epsfig{file=BMS-POS.eps, width=0.45\columnwidth}
}
\subfigure[WV]{
%\begin{minipage}[c]{0.48\textwidth}
%  \includegraphics[width=0.5\columnwidth]{BMS-WEB.eps}
%\end{minipage}%
\epsfig{file=BMS-WEB.eps, width=0.45\columnwidth}
}
\hfill
\subfigure[Retail]{
%\begin{minipage}[c]{0.48\textwidth}
%  \includegraphics[width=0.5\columnwidth]{retail.eps}
%\end{minipage}%
\epsfig{file=retail.eps, width=0.45\columnwidth}
}
\subfigure[Syn]{
%\begin{minipage}[c]{0.48\textwidth}
%  \includegraphics[width=0.5\columnwidth]{r50w.eps}
%\end{minipage}%
\epsfig{file=r50w.eps, width=0.45\columnwidth}
}
...
%If $t_{max}$ is too large, it will result in waste of space. 
We set $t_{max} = 500$ since it is an appropriate time
for the execution of each divide-and-conquer problem. 

%In what follows, w
First we present results in data utility, then the
...
%\begin{minipage}[c]{0.48\textwidth}
%\centering
%  \epsfig{file=loss3.eps, width=0.4\columnwidth}
%\end{minipage}%
\epsfig{file=loss3.eps, width=0.45\columnwidth}
}
\hfill
\subfigure[$\rho=0.7$]{\label{fig:loss-b}
%\begin{minipage}[c]{0.48\textwidth}
%\centering
%  \epsfig{file=loss7.eps, width=0.4\columnwidth}
%\end{minipage}%
\epsfig{file=loss7.eps, width=0.45\columnwidth}
}
\caption{Comparisons in Information Loss}\label{fig:loss}
\end{figure}


\figref{fig:loss} show that in terms 
...
%even though it tries to minimize the information loss at each 
%iteration. 
...
%\end{minipage}%
\epsfig{file=relative3.eps, width=0.45\columnwidth}
}
...
%\end{minipage}%
\epsfig{file=relative7.eps, width=0.45\columnwidth}
}
\caption{Comparisons in Symmetric K-L Divergence}
\label{fig:entropy}
\end{figure}

\figref{fig:entropy} show that $Dist$ 
...
\figref{fig:rulemining} compare the 
...
%\end{minipage}%
\epsfig{file=js3.eps, width=0.45\columnwidth}
...
%\end{minipage}%
\epsfig{file=js7.eps, width=0.45\columnwidth}
}
...
%Furthermore, increased level of partitioning causes the algorithm to %witness superlinear speedup in Figure \ref{fig:scale:a}. 
...
%\end{minipage}%
\epsfig{file=scaletime.eps, width=0.45\columnwidth}
}
...
%\end{minipage}%
\epsfig{file=scaletimeno.eps, width=0.45\columnwidth}
...
%\end{minipage}%
\epsfig{file=infoloss.eps, width=0.45\columnwidth}
}
...
%\end{minipage}%
\epsfig{file=KL.eps, width=0.45\columnwidth}
}
\subfigure[On rule mining (cutoff=5)]{\label{fig:rulemining3}
%\begin{minipage}[c]{0.48\textwidth}
%\centering
%\includegraphics[width=\textwidth]{J.eps}
%\end{minipage}%
\epsfig{file=J.eps, width=0.45\columnwidth}
}
...
We give the performance of our
...
%\end{minipage}%
\epsfig{file=timebond_avg.eps, width=0.45\columnwidth}
}
...
%\end{minipage}%
\epsfig{file=timebond.eps, width=0.45\columnwidth}
}
...
%\end{minipage}%
\epsfig{file=buffersizeavg.eps, width=0.45\columnwidth}
}
...
%\end{minipage}%
\epsfig{file=buffersize.eps, width=0.45\columnwidth}
}
