...
Finally, with two separate methods (\secref{sec:sim}),
...
English words from a large lemmatized English corpus (illustrated in \secref{sec:dataeval} ) and translate
...
\begin{figure}[]
\centering
\epsfig{file=vector.eps, width=\columnwidth}
