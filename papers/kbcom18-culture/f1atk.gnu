...
# epslatex
set terminal epslatex size 3.5,2.62 color colortext font ',8'
set output 'f1atk.tex'
...
set xrange [0:190]
set yrange [0:0.6]
plot (346*x)/(379*(x + 173)) ls 4 t 'ER', \
     'f1atk.dat' index 0 with linespoints ls 1 t 'PR', \
