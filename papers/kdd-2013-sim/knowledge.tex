\section{Semantic Network and Synsets}
\label{sec:knowledge}
...
%%\\
%%P(c|e) = \frac{\mbox{occurrences of }(c,e)\mbox{ in Hearst extraction}}{\mbox{occurrences of }e\mbox{ in Hearst extraction}}
%\end{aligned}
%}
%\end{displaymath}
\end{itemize}
\begin{figure*}[t]\label{probaseFrame}
 \centerline{
 \includegraphics[width=0.95\textwidth]{probaseFrame.eps}}
...
We address this issue in two steps.  First, we use the available sources such as
