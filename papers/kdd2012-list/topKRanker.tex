...
the title, and one of them should be the central concept of the ``top-$k$'' 
list. Our key idea is that one or more items from the main list 
should be instances of one of the concepts extracted from the title.
Probase taxonomy is used for this concept-instance matching. We 
design a scoring function in the ranker that measure the amount of
matching as well as the visual features of a given list.
