...
Zhixian Zhang\\
       ...
       \email{\small zhangzhixian1989@gmail.com}
\alignauthor
...
Haixun Wang\\
       ...
       \email{\small Haixun.Wang@microsoft.com}
}
\maketitle
...
%1) title recognization to identify a ``top-k'' page by its title;
...
\begin{keywords}
Web information extraction, top-k lists, list extraction
\end{keywords}
