...
set xrange [22:50]
plot 'clustersize2.dat' using 1:2:xtic(1) with linespoints ls 2 t "LDA",\
'clustersize2.dat' using 1:3:xtic(1) with linespoints ls 3 t "DCMLDA",\
'clustersize2.dat' using 1:4:xtic(1) with linespoints ls 1 t "SLDA"
