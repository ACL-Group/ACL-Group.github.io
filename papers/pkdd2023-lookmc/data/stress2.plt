...
plot file every ::43::49 using 2 w lp  lw 4.5 pt 2 ps 1.0 notitle, \
                 "" every ::43::49 using 3 w lp  lw 4.5 pt 4 ps 1.0 notitle,\
                 "" every ::43::49 using 4 w lp  lw 4.5 pt 6 ps 1.0 notitle,\
                 "" every ::43::49 using 5 w lp  lw 4.5 pt 8 ps 1.0 notitle,\
                 "" every ::43::49 using 6 w lp  lw 4.5 pt 12 ps 1.0 lc 'red' notitle 
set output
...
#set xtics ('Neg+' 0, 'Neg-' 1, 'NER' 2, 'PR' 3, 'PI' 4, "Adv" 5, "Voice" 6, "Syn" 7)
set yrange [20: 100]
plot file every ::51::57 using 2 w lp  lw 4.5 pt 2 ps 1.0 notitle, \
                 "" every ::51::57 using 3 w lp  lw 4.5 pt 4 ps 1.0 notitle,\
                 "" every ::51::57 using 4 w lp  lw 4.5 pt 6 ps 1.0 notitle,\
                 "" every ::51::57 using 5 w lp  lw 4.5 pt 8 ps 1.0 notitle,\
                 "" every ::51::57 using 6 w lp  lw 4.5 pt 12 ps 1.0 lc 'red' notitle 
...
set xtics ('Neg+' 0, 'Neg-' 1, 'NER' 2, 'PR' 3, 'PI' 4, "Voice" 5)
set yrange [20: 100]
plot file every ::59::65 using 2 w lp  lw 4.5 pt 2 ps 1.0 notitle, \
                 "" every ::59::65 using 3 w lp  lw 4.5 pt 4 ps 1.0 notitle,\
                 "" every ::59::65 using 4 w lp  lw 4.5 pt 6 ps 1.0 notitle,\
                 "" every ::59::65 using 5 w lp  lw 4.5 pt 8 ps 1.0 notitle,\
                 "" every ::59::65 using 6 w lp  lw 4.5 pt 12 ps 1.0 lc 'red' notitle 
...
set yrange [0: 100]
set xtics center offset 0, -1
plot file every ::67::72 using 2 w lp  lw 4.5 pt 2 ps 1.0 notitle, \
                 "" every ::67::72 using 3 w lp  lw 4.5 pt 4 ps 1.0 notitle,\
                 "" every ::67::72 using 4 w lp  lw 4.5 pt 6 ps 1.0 notitle,\
                 "" every ::67::72 using 5 w lp  lw 4.5 pt 8 ps 1.0 notitle,\
                 "" every ::67::72 using 6 w lp  lw 4.5 pt 12 ps 1.0 lc 'red' notitle
set output
...
set yrange [0: 100]
set xtics center offset 0, -1
plot file every ::74::79 using 2 w lp  lw 4.5 pt 2 ps 1.0 notitle, \
                 "" every ::74::79 using 3 w lp  lw 4.5 pt 4 ps 1.0 notitle,\
                 "" every ::74::79 using 4 w lp  lw 4.5 pt 6 ps 1.0 notitle,\
                 "" every ::74::79 using 5 w lp  lw 4.5 pt 8 ps 1.0 notitle,\
                 "" every ::74::79 using 6 w lp  lw 4.5 pt 12 ps 1.0 lc 'red' notitle
...
set yrange [0: 100]
set xtics center offset 0, -1
plot file every ::81::86 using 2 w lp  lw 4.5 pt 2 ps 1.0 notitle, \
                 "" every ::81::86 using 3 w lp  lw 4.5 pt 4 ps 1.0 notitle,\
                 "" every ::81::86 using 4 w lp  lw 4.5 pt 6 ps 1.0 notitle,\
                 "" every ::81::86 using 5 w lp  lw 4.5 pt 8 ps 1.0 notitle,\
                 "" every ::81::86 using 6 w lp  lw 4.5 pt 12 ps 1.0 lc 'red' notitle
set output
