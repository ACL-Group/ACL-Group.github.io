...
plot 'loss3a.dat' using 2  title "TDControl" fs pattern 0 lt -1,\
'loss3a.dat' using 3 title "Global" fs pattern 1 lt -1,\
'loss3a.dat' using 4 title "Mine" fs pattern 2 lt -1,\
'loss3a.dat' using 5 title "Dist" fs pattern 3 lt -1
