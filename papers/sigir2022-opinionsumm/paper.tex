...
\title{Opinion Summarization by Weak-Supervision from Semi-Structured Data}
...
Most previous dataset creation methods construct summary 
and its multi-review based on textual similarities between reviews.
The disadvantage of this approach is that some information of the summary may 
be missing from its input reviews. In this paper, 
...
We propose a new method to synthesize semi-structured training pairs 
with OAs and ISs as input and textual summary as output,
...
state-of-the-art baselines on Yelp, Amazon and RottenTomatos datasets.
\end{abstract}
...
\keywords{opinion summarization, weak-supervision, semi-structure, opinion-aspect pairs, implicit sentences}
