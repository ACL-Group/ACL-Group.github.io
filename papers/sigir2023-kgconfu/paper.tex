...
\acmConference[SIGIR '23]{The 46th International ACM
SIGIR Conference on Research and Development in Information
Retrieval}{July 23--27, 2023}{Taipei, Taiwan}
%
...
\newcommand{\sansa}[1]{\small{\textcolor{orange}{(#1 --sansa)}}}
\newcommand{\zelin}[1]{\small{\textcolor{purple}{(#1 --zelin)}}}
%%
%% Submission ID.
...
\end{abstract}
% However, conventional fusion approaches under-utilize the internal structure of KG, yielding sub-optimal performance.
% However, some conventional knowledge fusion methods with KG cannot solve the problem fundamentally.
% \zelin{component -> task}
% called MeituAn Product Search (MAPS)

% The code and part of the data is temporarily released at https://anonymous.4open.science/r/anonymized_repo/, while the full version of the code and data will be released after the paper is accepted.
...
\keywords{product search relevance, e-commerce, knowledge graph, contrastive learning}
