...
If SRL lexicons like FrameNet provides coarse-grained semantics for
...
%One candidate technique toward this goal is selection preference
%(SP) proposed by Resnik \cite{}.
%SP is an unsupervised traditional NLP technique
%for computing whether a term or a class of terms is preferred by a verb
%to act as its argument. Together with a taxonomy of concepts or terms,
%SP can produce a ranked list of concepts that are most appropriate subjects
%or objects of a verb.
%However, these classes are not guaranteed to be the largest, nor are they
%disjoint by any means. In fact, one class could be contained by another under
%this scheme.
...
\multirow{3}{*}{connect} & device         &  Items  & invention \\
      ...
      \hline
%\multirow{3}{*}{eat} & food            & Ingestibles & art subject \\
%      &  word            &       & organism classification \\
%      &  time           &       & character species \\
%      \hline
