...
Once we download audio samples (details in \secref{sec:collect-audio})
...
each comprised of a fix number of sample points, as in \fig{fra}.
...
\begin{figure}[th]
\centering
\epsfig{file=figures/frame.eps,width=\columnwidth}
...
\end{equation}
and $N$ and $x(i)$ have the same meaning as \eqn{en}.
